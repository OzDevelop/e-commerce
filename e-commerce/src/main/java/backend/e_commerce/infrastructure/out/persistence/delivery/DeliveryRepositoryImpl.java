...
public class DeliveryRepositoryImpl implements DeliveryRepository {
    ...
    public Delivery save(Delivery delivery) {
        OrderEntity orderEntity = orderRepository.findByOrderId(delivery.getOrderId())
                .orElseThrow(() -> new EntityNotFoundException("OrderEntity not found with id: " + delivery.getOrderId()));
    ...
    public Delivery update(Delivery delivery) {
        ...
        DeliveryEntity entity = jpaDeliveryRepository.findById(delivery.getId())
                .orElseThrow(() -> new EntityNotFoundException("Delivery not found with id: " + delivery.getId()));
